                ...
                if ($socket == $this->master) {
                    ...
                    if ($numBytes === false) {
                        ...
                        switch ($sockErrNo)
                        {
                            ...
                            case 108: // ESHUTDOWN    -- Cannot _send after transport endpoint shutdown -- probably more of an error on our part, if we're trying to write after the socket is closed.  Probably not a critical error, though.
                    ...
                    elseif ($numBytes == 0) {
                        ...
                        if (!$user->handshake) {
                            ...
                            //split packet into frame and _send it to deframe
